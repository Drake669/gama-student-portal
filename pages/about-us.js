                ...
                <div className="col-xl-5 col-lg-6">
                  <div className="about__title-wrap">
                    ...
                    <p className="fw-medium">
                      GAMA Learning Institute is a premier provider of
                      specialized Business and Managerial Training in Saint
                      Lucia and the Eastern Caribbean.
                    </p>
                    <p>
                      Since 2003, GAMA Learning Institute has helped
                      organizations improve productivity and service standards
                      by helping to develop quality systems which inspire higher
                      service standards, and which motivate management and
                      front-line personnel to consistently maintain the highest
                      levels of organizational productivity. The mission of GAMA
                      Learning Institute is to facilitate the development of
                      capacity for professional human development and
                      advancement. The vision of the Institute is to become the
                      premier provider of affordable certification training,
                      helping to improve the efficiency and productivity of
                      businesses in the Caribbean Region.
                    </p>
              ...
              <div className="row justify-content-center">
                <div className="col-xl-8 col-lg-10">
                  <div className="cta__content">
                    <p>ARE YOU READY TO ELEVATE YOUR SKILLS</p>
                    <h2 className="title">Join Our Community</h2>
                    <h5 className="sub-title">Of Active Student’s</h5>
                    <div className="tg-button-wrap justify-content-center">
                      <Link href="/login" className="btn2 btn tg-svg">
